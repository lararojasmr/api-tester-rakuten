...
class TVideoQualitiesPost(VideoQualities):

    def test_video_qualities_add_new(self, api_ops, json_schema_validator):
        # Precondition: We have and item add in the system
        new_quality = api_ops.post(url=TVideoQualitiesPost.path, json={
        ...
        response = api_ops.get(TVideoQualitiesPost.path + '/' + str(json.loads(new_quality.content)['id']))
    ...
    def test_video_qualities_add_new_default(self, api_ops):
        # Precondition: We have and item add in the system with default
        quality_one = api_ops.post(url=TVideoQualitiesPost.path, json={
        ...
        quality_one = api_ops.get(TVideoQualitiesPost.path + '/' + str(quality_one_obj['id']))
        assert quality_one.status_code == 200
        assert quality_one_obj['default'] == True

        # Create a new default records
        quality_two = api_ops.post(url=TVideoQualitiesPost.path, json={
            "name": "The Chum's AudioQuality " + str(round(time.time() * 1000)),
            "abbr": "TCAQ " + str(round(time.time() * 1000)),
            "default": True
        })
        ...
        quality_two = api_ops.get(TVideoQualitiesPost.path + '/' + str(quality_two_obj['id']))
    ...
    def test_video_qualities_add_new_name_empty(self, api_ops, json_schema_validator):
        # Precondition: We have and item add in the system with default
        quality_one = api_ops.post(url=TVideoQualitiesPost.path, json={
            "name": "",
            "abbr": "TCAQ " + str(round(time.time() * 1000))
    ...
    def test_video_qualities_add_new_without_name(self, api_ops, json_schema_validator):
        # Precondition: We have and item add in the system with default
        quality_one = api_ops.post(url=TVideoQualitiesPost.path, json={
            "name": None,
            "abbr": "TCAQ " + str(round(time.time() * 1000))
    ...
    def test_video_qualities_add_new_abbr_empty(self, api_ops, json_schema_validator):
        # Precondition: We have and item add in the system with default
        quality_one = api_ops.post(url=TVideoQualitiesPost.path, json={
            "name": "The Chum's AudioQuality " + str(round(time.time() * 1000)),
            "abbr": ""
    ...
    def test_video_qualities_add_new_without_abbr(self, api_ops, json_schema_validator):
        # Precondition: We have and item add in the system with default
        quality_one = api_ops.post(url=TVideoQualitiesPost.path, json={
            "name": "The Chum's AudioQuality " + str(round(time.time() * 1000)),
            "abbr": None
    ...
    def test_video_qualities_add_new_unique_name(self, api_ops, json_schema_validator):
        # Precondition: We have and item add in the system with default
    ...
    def test_video_qualities_add_new_unique_abbr(self, api_ops, json_schema_validator):
        # Precondition: We have and item add in the system with default
